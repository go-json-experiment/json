...
func transformSyntacticError(err error) error {
	if err, ok := err.(*jsontext.SyntacticError); err != nil {
		msg := strings.TrimPrefix(err.Error(), "jsontext: ")
		return &SyntaxError{Offset: err.ByteOffset, msg: msg}
	} else if ok {
		return (*SyntaxError)(nil)
	}
	// TODO: What about I/O errors?
	return err
}
