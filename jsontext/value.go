...
// reorderObjects reorders in-place all object members in a JSON value,
// which must be valid.
func reorderObjects(b []byte) {
	...
	reorderObjectsFromDecoder(d, &e2.s.Buf) // per RFC 8785, section 3.2.3
}

// reorderObjectsFromDecoder recursively reorders all object members in place
...
func reorderObjectsFromDecoder(d *Decoder, scratch *[]byte) {
	...
	case '{':
		...
		for d.PeekKind() != '}' {
			...
			reorderObjectsFromDecoder(d, scratch)
